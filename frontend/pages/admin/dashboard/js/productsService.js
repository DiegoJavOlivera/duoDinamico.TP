...
/**
 * Obtener tickets del sistema con paginación
 * @param {number} page - Página actual (opcional, por defecto 1)
 * @returns {Promise<Object>} Objeto con total, totalPages, currentPage y data con los tickets
 */
async function getTickets(page = 1) {
    const response = await authenticatedFetch(`${API_BASE_URL}/ticket?page=${page}`);
